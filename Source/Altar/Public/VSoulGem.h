...
class ALTAR_API AVSoulGem : public AVActor, public IReactToFreezeInterface, public IVPhysicsControllable, public IVTransformPairable {
    GENERATED_BODY()
public:
    ...
    AVSoulGem(const FObjectInitializer& ObjectInitializer);
