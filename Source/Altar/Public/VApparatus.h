...
#include "VApparatus.generated.h"
...
class ALTAR_API AVApparatus : public AVActor, public IReactToFreezeInterface, public IVPhysicsControllable, public IVTransformPairable {
    GENERATED_BODY()
public:
    ...
    AVApparatus(const FObjectInitializer& ObjectInitializer);
