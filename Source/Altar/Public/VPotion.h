...
class ALTAR_API AVPotion : public AVActor, public IReactToFreezeInterface, public IVPhysicsControllable, public IVTransformPairable {
    GENERATED_BODY()
public:
    ...
    AVPotion(const FObjectInitializer& ObjectInitializer);
