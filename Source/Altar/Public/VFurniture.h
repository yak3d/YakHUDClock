...
#include "VFurniture.generated.h"
...
class ALTAR_API AVFurniture : public AVActor, public IReactToFreezeInterface, public IVPhysicsControllable, public IVTransformPairable {
    GENERATED_BODY()
public:
    ...
    AVFurniture(const FObjectInitializer& ObjectInitializer);
